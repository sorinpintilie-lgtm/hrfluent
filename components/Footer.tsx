        ...
        <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/services" className="text-base text-muted hover:text-primary transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/about" className="text-base text-muted hover:text-primary transition-colors">
                  About Us
                </Link>
              </li>
              <li>
                <Link href="/contact" className="text-base text-muted hover:text-primary transition-colors">
                  Contact
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link href="#" className="text-base text-muted hover:text-primary transition-colors">
                  Privacy Policy
                </Link>
              </li>
              <li>
